...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(projects.modules.game.ui)
            implementation(projects.modules.search.data)
            implementation(projects.modules.search.domain)
...
android {
    namespace = "com.sermut.gamepediaapp"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.sermut.gamepediaapp"
...
compose.desktop {
    application {
        mainClass = "com.sermut.gamepediaapp.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.sermut.gamepediaapp"
